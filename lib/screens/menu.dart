...
import 'package:football_shop_mobile/screens/productlist_form.dart'; // Import the form page
...
class MyHomePage extends StatelessWidget {
  ...
  final String nama = "Muhammad Geriya Itsa"; //nama
  final String npm = "2406434172"; //npm
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        // Judul aplikasi "Football Products" dengan teks putih dan tebal.
        title: const Text(
          'Football Products',
          style: TextStyle(
            color: Colors.white,
